...
public class TablaCarrera implements Initializable {
    private final ObservableList<Carrera> carreraLista;
    
    public TablaCarrera() {
        this.carreraLista = FXCollections.observableArrayList();
    }
    ...
    private TableColumn<Carrera,String> colMateria;
    @FXML
...
// Limpiar la selección 
    ...
    configurarVentana, rellenarTablaCarrera, refrescar(ActionEvent), refresch, nuevo, 
    seleccion, buscarTodos, buscarCarrera, buscarCarreraNoombre, buscaCarreraAnio
    ...
    */
     ...
     public void configurarVentana(){
      ...
      public void rellenarTablaCarrera(){
        ...
        //System.out.println("Resultado de buscar en BD es  "+ resultCarrera.get(0));
      ...
      // JOptionPane.showMessageDialog(null, "Entro al metodo rellenarTabla", "Error",JOptionPane.WARNING_MESSAGE);
    }  
    ...
    public void refrescar(ActionEvent event) {
     ...
     public void refrescarTabla(){
        // JOptionPane.showMessageDialog(null, "Entro al imetodo refrescar tabla", "Error",JOptionPane.WARNING_MESSAGE);        
         if(tblCarrera != null && carreraLista != null){
             tblCarrera.setItems(carreraLista);
             JOptionPane.showMessageDialog(null, "Entro al if refrescar tabla, ","Error",JOptionPane.WARNING_MESSAGE);
         }
     }       
    ...
    @FXML
    private void seleccionar(MouseEvent event) {//MouseEvent event
        ...
        if(c ==null){            
          ...
          try {            
            ...
            Stage stage = new Stage(); 
            stage.setUserData(c);
            this.tblCarrera.getSelectionModel().clearSelection();
            stage.initModality(Modality.APPLICATION_MODAL);//modal : hasta que no termine el no me deje
            stage.setScene(scene);            
            stage.showAndWait();  
