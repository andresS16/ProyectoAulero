...
public ObservableList<Horario> buscarTodos() {
    ...
    try {
        ...
        while (rs.next()) {
            ...
            if (dia.equals("lunes")) {
                horarioReserva.setLunes("id_reserva "+idReserva);
            } else if (dia.equals("martes")) {
                horarioReserva.setMartes("id_resrva "+idReserva);
            } else if (dia.equals("miercoles")) {
                horarioReserva.setMiercoles("id_resrva "+idReserva);
            } else if (dia.equals("jueves")) {
                horarioReserva.setJueves("id_resrva "+idReserva);
            } else if (dia.equals("viernes")) {
                horarioReserva.setViernes("id_resrva "+idReserva);
            }
        }
        rs.close();
    } catch (SQLException ex) {
